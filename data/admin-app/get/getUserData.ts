...
type RoleCode = keyof typeof roleMap;
type TitleCode = keyof typeof titleMap;
...
export async function getUserData(): Promise<CombinedResult> {
  ...
  try {
    ...
    return {
      ...
      title: titleMap[userData.title as keyof typeof titleMap] || userData.title,      titleCode: userData.title,
