...
import { transformGamePlaysQBs, transformGamePlaysTeam } from "@/data/app/get/transformGame";
...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      ...
      <h2>Game Stats</h2>
      <GameDashboard 
        teamStats={transformGamePlaysTeam(allPlays)} 
        qbStats={await (transformGamePlaysQBs(allPlays) as unknown as TransformedQBData)}
      />      
      <h2>Log Plays</h2>
